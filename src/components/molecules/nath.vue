    ...
    <div class="w-1/2 bg-black text-white flex flex-col justify-center items-center px-10">
      <div class="text-center w-3/4">
        ...
        <p class="text-center mt-4 text-gray-400">
          Not a member? <a href="#" class="text-indigo-400 font-semibold">Start here</a>
        </p>
      </div>
    </div>
...
<style scoped>
/* Estilos de la transición anterior (opcionalmente puedes eliminarlos si solo quieres el nuevo estilo) */
...
/* Nuevo estilo de transición para el Toast */
